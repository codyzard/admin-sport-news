...
import { getCategoryWithNewsRequest } from "../../actions";
      ...
      (cate, index) => {
        return (
          <Bar
            key={index}
            data={{
              labels: cate.sub_cate.map((cate) => {
                return cate.name;
              }),
              datasets: [
                {
                  label: "Số lượng tin tức",
                  data: cate.sub_cate.map((cate) => {
                    return cate.cate_news;
                  }),
                  backgroundColor: cate.sub_cate.map(() => {
                    return colorArray[
            ...
            options={{
              ...
              title: {
                display: true,
                text: "Số lượng tin tức theo danh mục " + cate.name,
                fontSize: 15
              },
...
const mapStateToProps = (state) => {
  return {
    category_with_news: state.category_with_news,
  };
};
const mapDispatchToProps = (dispatch, props) => {
  return {
    getCategoryWithNews: () => {
      return dispatch(getCategoryWithNewsRequest());
    },
  };
};
